module Adder_tb;
  ...
  initial begin
    $dumpfile("/tmp/Adder_tb.vcd");
    $dumpvars(0, Adder_tb);

    a_in[0] = 16'h0000; b_in[0] = 16'h0000; expected[0] = 16'h0000;
    a_in[1] = 16'h0001; b_in[1] = 16'h0000; expected[1] = 16'h0001;
    a_in[2] = 16'h0000; b_in[2] = 16'h0001; expected[2] = 16'h0001;
    a_in[3] = 16'h0001; b_in[3] = 16'h0001; expected[3] = 16'h0002;
    a_in[4] = 16'h0808; b_in[4] = 16'h0808; expected[4] = 16'h1010;
    a_in[5] = 16'hF0F0; b_in[5] = 16'h0F0F; expected[5] = 16'hFFFF;
    a_in[6] = 16'hFFFF; b_in[6] = 16'h0001; expected[6] = 16'h0000;
